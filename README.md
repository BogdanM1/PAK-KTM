...
![Alt text](imgs/Diag1.png?raw=true "Ток података")

![Alt text](imgs/Diag2.png?raw=true "Којић транспорт елемент")

![Alt text](imgs/Diag3.png?raw=true "Конективни елементи")

![Alt text](imgs/results1.png?raw=true "Поређење smeared и детаљног модела")
